...
## Addendum v0.9.1 — Regras críticas
- Categorização IA automática apenas com limiar mínimo de confiança.
- Regras determinísticas têm precedência sobre fallback IA.
- Toda persistência deve ser obrigatoriamente workspace-scoped.
<<<<<<< ours
>>>>>>> theirs
=======
>>>>>>> theirs
