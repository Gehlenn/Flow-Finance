...
- `docs/DEPLOYMENT_STATUS.md:30-37` indica `/health`, `/api/health`, `/api/version` em 404 na revalidação de 2026-05-08.
...
- `Product Plan.md` diz NÃO super-app, NÃO Open Finance como eixo, NÃO "CFO autônomo".
- Código atual:
...
- `docs/DEPLOYMENT_STATUS.md:50-56` lista `VITE_SENTRY_DSN`/`SENTRY_DSN` como pendentes.
- Resultado: produção sem observabilidade efetiva.
