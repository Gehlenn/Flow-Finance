        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="relative">
            ...
            <input 
              ...
              className="w-full pl-14 pr-6 py-5 bg-slate-50 rounded-2xl border-2 border-transparent focus:border-indigo-500/20 focus:bg-white text-sm font-medium text-slate-700 outline-none transition-all"
            />
          </div>
