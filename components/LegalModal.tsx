        ...
        return (
          <div className="space-y-6 text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
            <div className="space-y-2">
              <h4 className="font-semibold text-slate-800 dark:text-white uppercase tracking-wide text-xs">1. Introdução</h4>
            ...
            <div className="space-y-2">
              <h4 className="font-semibold text-slate-800 dark:text-white uppercase tracking-wide text-xs">5. Alterações</h4>
        ...
        return (
          <div className="space-y-6 text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
            <div className="text-center pb-4 border-b border-slate-100 dark:border-slate-700">
              <p className="font-semibold text-2xl text-slate-800 dark:text-white tracking-tight">© 2026 Flow Finance</p>
              <p className="text-xs uppercase tracking-[0.08em] text-slate-400 mt-1">Todos os direitos reservados</p>
            </div>

            <div className="space-y-2">
              <h4 className="font-semibold text-slate-800 dark:text-white uppercase tracking-wide text-xs">Declaração de Propriedade</h4>
            ...
            <div className="space-y-2">
              <h4 className="font-semibold text-slate-800 dark:text-white uppercase tracking-wide text-xs">Tecnologias e Licenças</h4>
