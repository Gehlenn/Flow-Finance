      ...
      <div className="bg-white dark:bg-slate-800 rounded-[2rem] p-6 border border-slate-100 dark:border-slate-700 space-y-6 shadow-sm">
        <div className="grid gap-3 md:grid-cols-3">
          <label className="space-y-2">
            ...
            <select
              ...
              className="w-full p-3 rounded-2xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-700 text-sm text-slate-700 dark:text-slate-100"
            >
          ...
          <label className="space-y-2">
            <span className="text-xs font-semibold uppercase tracking-[0.08em] text-slate-400 flex items-center gap-2"><Filter size={14} /> Recurso</span>
            <select
              value={resourceType}
          ...
          <label className="space-y-2">
            <span className="text-xs font-semibold uppercase tracking-[0.08em] text-slate-400 flex items-center gap-2"><Search size={14} /> Buscar</span>
            <input
              value={searchTerm}
        ...
        {loading ? (
          <div className="flex items-center gap-3 text-slate-500">
            ...
            <span className="text-sm">Carregando eventos de auditoria...</span>
          </div>
        ) : error ? (
          ...
          <div className="p-4 rounded-2xl border border-dashed border-slate-200 dark:border-slate-700 text-sm text-slate-500 dark:text-slate-300">
