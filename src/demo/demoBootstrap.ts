...
export function createDemoWorkspaceEntities(context: DemoWorkspaceContext): EntityState {
  ...
  const transactions: Transaction[] = [
    ...
    },
    {
      ...
      description: 'Equipe parceira de entrega',
      date: toIso(referenceDate, -6, 15),
    },
    {
      id: 'demo-tx-5',
      user_id: context.userId,
      ...
      description: 'Ferramentas de operacao',
      date: toIso(referenceDate, -11, 11),
    },
    {
      id: 'demo-tx-6',
      user_id: context.userId,
      ...
      type: TransactionType.DESPESA,
      category: Category.NEGOCIO,
      description: 'Aquisicao e relacionamento',
      date: toIso(referenceDate, -17, 14),
    },
    {
      id: 'demo-tx-7',
      user_id: context.userId,
    ...
    },
    {
      ...
      type: TransactionType.RECEITA,
      category: Category.NEGOCIO,
      description: 'Retainer mensal - Cliente Norte',
      date: toIso(referenceDate, -25, 11),
      recurring: true,
    ...
    },
    {
      ...
      type: TransactionType.RECEITA,
      category: Category.NEGOCIO,
      description: 'Workshop operacional - ciclo anterior',
      date: toIso(referenceDate, -35, 11),
    },
    {
      id: 'demo-tx-10',
      user_id: context.userId,
      ...
      type: TransactionType.DESPESA,
      category: Category.CONSULTORIO,
      description: 'Aluguel, internet e base operacional',
      date: toIso(referenceDate, -18, 9),
      recurring: true,
      recurrence_type: 'monthly',
    },
    {
      ...
      type: TransactionType.DESPESA,
      category: Category.INVESTIMENTO,
      description: 'Software de agenda e atendimento',
      date: toIso(referenceDate, -20, 9),
      recurring: true,
      recurrence_type: 'monthly',
    },
    {
      ...
      type: TransactionType.DESPESA,
      category: Category.NEGOCIO,
      description: 'Impostos e contabilidade',
      date: toIso(referenceDate, -8, 14),
      recurring: true,
      recurrence_type: 'monthly',
    },
    {
      ...
      type: TransactionType.DESPESA,
      category: Category.CONSULTORIO,
      description: 'Equipe parceira - sprint de entrega',
      date: toIso(referenceDate, -2, 15),
    },
    {
      id: 'demo-tx-14',
      user_id: context.userId,
      ...
      type: TransactionType.DESPESA,
      category: Category.NEGOCIO,
      description: 'Campanha de captacao para junho',
      date: toIso(referenceDate, -1, 10),
    },
  ];
  ...
  const reminders: Reminder[] = [
    ...
    {
      id: 'demo-rem-4',
      title: 'Servico extra aprovado - cliente Delta',
      date: toIso(referenceDate, 1, 9),
      type: ReminderType.TRABALHO,
      amount: 2600,
      completed: false,
      priority: 'alta',
    ...
    {
      id: 'demo-rem-5',
      title: 'Retainer junho - Cliente Norte',
      date: toIso(referenceDate, 12, 9),
      type: ReminderType.NEGOCIO,
      amount: 7200,
      completed: false,
      priority: 'media',
    ...
    {
      id: 'demo-rem-6',
      title: 'Fechamento de temporada - Projeto Orion',
      date: toIso(referenceDate, 28, 9),
      type: ReminderType.NEGOCIO,
      amount: 11800,
      completed: false,
      priority: 'media',
    ...
    {
      id: 'demo-rem-7',
      title: 'Implantacao aguardando aceite',
      date: toIso(referenceDate, -10, 9),
      type: ReminderType.TRABALHO,
      amount: 3400,
      completed: false,
      priority: 'alta',
  ...
  const receivables: Receivable[] = [
    ...
    },
    {
      ...
      tenant_id: context.tenantId,
      workspace_id: context.workspaceId,
      description: 'Implantacao aguardando aceite',
      expected_amount: 3400,
      realized_amount: 0,
      due_date: toIso(referenceDate, -10, 9),
      realized_at: null,
      status: 'overdue',
      source: 'reminder_migration',
      source_ref: 'demo-rem-7',
      customer_label: 'Cliente B2B',
      created_at: createdAt,
      updated_at: createdAt,
    },
    {
      ...
      tenant_id: context.tenantId,
      workspace_id: context.workspaceId,
      description: 'Servico extra aprovado - cliente Delta',
      expected_amount: 2600,
      realized_amount: 0,
      due_date: toIso(referenceDate, 1, 9),
      realized_at: null,
      status: 'open',
      source: 'reminder_migration',
      source_ref: 'demo-rem-4',
      customer_label: 'Cliente Delta',
      created_at: createdAt,
      updated_at: createdAt,
    },
    {
      ...
      tenant_id: context.tenantId,
      workspace_id: context.workspaceId,
      description: 'Retainer junho - Cliente Norte',
      expected_amount: 7200,
      realized_amount: 0,
      due_date: toIso(referenceDate, 12, 9),
      realized_at: null,
      status: 'open',
      source: 'reminder_migration',
      source_ref: 'demo-rem-5',
      customer_label: 'Cliente Norte',
      created_at: createdAt,
      updated_at: createdAt,
    },
    {
      ...
      tenant_id: context.tenantId,
      workspace_id: context.workspaceId,
      description: 'Fechamento de temporada - Projeto Orion',
      expected_amount: 11800,
      realized_amount: 0,
      due_date: toIso(referenceDate, 28, 9),
      realized_at: null,
      status: 'open',
      source: 'manual',
      source_ref: 'demo-contract-orion',
      customer_label: 'Projeto Orion',
      created_at: createdAt,
      updated_at: createdAt,
    },
  ];
  ...
  const goals: Goal[] = [
    ...
    },
    {
      ...
      tenant_id: context.tenantId,
      workspace_id: context.workspaceId,
      title: 'Provisao de impostos do ciclo',
      targetAmount: 9000,
      currentAmount: 4200,
      deadline: toIso(referenceDate, 35, 9),
      category: Category.NEGOCIO,
    },
  ];
